...
namespace com.tinylabproductions.u3d_gps_bridge {
	...
	public class Client {
		...
		private readonly AndroidJavaObject objectName;

		public Client() {
			callbacks = ConnectionCallbacks.GetInstance();
			objectName = new AndroidJavaObject("java.lang.String", ConnectionCallbacks.PARENT_GAMEOBJECT_NAME);
			client = new AndroidJavaObject("com.tinylabproductions.u3d_gps_bridge.U3DGamesClient", objectName);
			serviceStatus = getServiceStatus();
		}

		public bool connected { get { return client.Call<bool>("isConnected"); } }

		public bool supported { get { return serviceStatus == ServiceStatus.Supported; } }
		...
		public string getAuthorizationCode() {
			return client.Call<string>("getAuthorizationCode");
		}

		public string getAccountId() {
			return client.Call<string>("getAccountId");
		}

		public string getAccountName() {
			return client.Call<string>("getAccountName");
		}
		...
		private ServiceStatus getServiceStatus() {
			if(client.Call<bool>("isSupported"))
				return ServiceStatus.Supported;
			if(client.Call<bool>("isServiceMissing"))
				return ServiceStatus.Missing;
			if(client.Call<bool>("isServiceVersionUpdateRequired"))
				return ServiceStatus.VersionUpdateRequired;
			if(client.Call<bool>("isServiceDisabled"))
				return ServiceStatus.Disabled;
			if(client.Call<bool>("isServiceInvalid"))
